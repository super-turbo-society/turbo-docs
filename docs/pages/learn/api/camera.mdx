...
```rs
camera::pan(target: (i32, i32), duration: usize, easing: Easing)
```

| Param      | Type         | Default | Description                                                                             |
| :--------- | :----------- | :------ | :-------------------------------------------------------------------------------------- |
| `target`   | `(i32, i32)` |         | The target x and y position to ease the camera to.                                      |
...
```rust
let bounds = bounds::size(16, 16).position(32, 64);
camera::pan(bounds.center(), 30, Easing::EaseOutQuad);
```
...
| Param     | Type     | Default | Description                                       |
| :-------- | :------- | :------ | :------------------------------------------------ |
| `delta_x` | `number` |         | Number of pixels to move the camera horizontally. |
| `delta_y` | `number` |         | Number of pixels to move the camera vertically.   |
...
// Using Bounds to snap to a 16x16 player sprite
...
camera::pan(player_center, duration, easing);
```
...
// Continuous shake (like earthquake)
