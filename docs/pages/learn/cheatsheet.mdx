...
Turbo provides a straightforward way to initialize the standard game state. After creating a new struct with GameState values, initialize the state in the 'new' function:
