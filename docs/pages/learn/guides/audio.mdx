...
Large and/or unused audio files can bloat your game size and cause long load times loading or even errors on the web. Make sure audio files are as small as possible. Remove audio files that aren't being used in your game.
:::
